...
const ProjectCard: React.FC<{
    ...
    return (
        <motion.div
            ...
            className="group relative flex flex-col glass rounded-[40px] overflow-hidden hover:neon-glow transition-all duration-500 border-white/5"
        >
            {/* Image Placeholder */}
            <div className="relative h-64 overflow-hidden bg-surface-medium">
                <div
                ...
                <div className="absolute inset-0 flex items-center justify-center opacity-20 group-hover:opacity-40 transition-opacity">
                    <span className="text-4xl font-bold tracking-tighter opacity-10 uppercase">
            ...
            <div className="p-8 flex flex-col flex-grow">
                <div className="flex flex-wrap gap-2 mb-4">
                    {project.tags.map((tag) => (
                        <span
                            key={tag}
                            className="px-3 py-1 glass text-[10px] font-mono tracking-wider rounded-full uppercase text-gray-400 group-hover:text-accent-neon transition-colors"
                        >
                            {tag}
                        </span>
                    ))}
                ...
                <motion.button
                    whileHover={{ x: 5 }}
                    className="flex items-center gap-2 text-white font-medium text-sm group-hover:text-accent-neon transition-colors"
                >
                    View Case Study
        ...
        <section id="projects" className="py-32 relative bg-background">
            ...
            <div className="container mx-auto px-6 relative z-10">
                <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
                    ...
                    >
                        <button className="px-10 py-4 glass rounded-full text-sm font-bold tracking-widest uppercase hover:bg-white hover:text-background transition-all duration-500">
                            Browse All Projects
                        </button>
                    </motion.div>
                </div>
                ...
                >
                    <button className="w-full py-4 glass rounded-full text-sm font-bold tracking-widest uppercase">
                        Browse All Projects
                    </button>
                </motion.div>
            </div>
